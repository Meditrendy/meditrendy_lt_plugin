...
require_once MEDITRENDY_CORE_DIR . 'includes/product-preset-accordion.php';
...
require_once MEDITRENDY_CORE_DIR . 'includes/omniva-blocks-ajax-compat.php';
...
require_once MEDITRENDY_CORE_DIR . 'includes/admin-order-custom-items.php';
