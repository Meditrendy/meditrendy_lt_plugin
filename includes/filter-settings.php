...
function meditrendy_core_translate_ui_text($text) {
    ...
    $translations = [
        ...
        'et' => [
            ...
            'KAINA' => 'HIND',
            'NAUJIENA' => 'UUS',
            'ProduktĹł nerasta' => 'Tooteid ei leitud',
            'Reset' => 'Lähtesta',
            'Rodyti produktus' => 'Näita tooteid',
            'Rodyti rezultatus' => 'Näita tulemusi',
            'SPALVA' => 'VÄRV',
            'SkaiÄŤiuojama...' => 'Arvutamine...',
            'Uzdaryti filtrus' => 'Sulge filtrid',
            'Aktyvus filtrai' => 'Aktiivsed filtrid',
        ],
        'pl' => [
            'AKCIJA' => 'PROMOCJA',
            'Akcija' => 'Promocja',
